...
const CLIENT_ID = process.env.NEXT_PUBLIC_AMADEUS_CLIENT_ID || "9hG6vqT2zfB6dfbdTeZa6H8VU1JQNhGA";
const CLIENT_SECRET = process.env.NEXT_PUBLIC_AMADEUS_CLIENT_SECRET || "BCQGA3ZiCVf7lkGG";
